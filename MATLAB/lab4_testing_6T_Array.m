...
directory0 = sprintf('%s/MATLAB/%s.psf', getenv('HOME'), '6T_Array_Result0');
directory1 = sprintf('%s/MATLAB/%s.psf', getenv('HOME'), '6T_Array_Result1');
directory2 = sprintf('%s/MATLAB/%s.psf', getenv('HOME'), '6T_Array_Result2');
directory3 = sprintf('%s/MATLAB/%s.psf', getenv('HOME'), '6T_Array_Result3');
directory4 = sprintf('%s/MATLAB/%s.psf', getenv('HOME'), '6T_Array_Result4');
directory5 = sprintf('%s/MATLAB/%s.psf', getenv('HOME'), '6T_Array_Result5');
directory6 = sprintf('%s/MATLAB/%s.psf', getenv('HOME'), '6T_Array_Result6');
directory7 = sprintf('%s/MATLAB/%s.psf', getenv('HOME'), '6T_Array_Result7');
